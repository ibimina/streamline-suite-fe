...
const Feature: React.FC<{ icon: React.ReactNode; name: string; description: string }> = ({
  icon,
  name,
  description,
}) => (
  ...
  const features = [
    {
      name: 'Quotations',
      description:
        'Create, customize, and send professional quotations with advanced pricing and multiple templates.',
      icon: <ClipboardListIcon className='h-6 w-6' />,
    },
    {
      name: 'Invoices',
      description:
        'Generate invoices from quotations in one click. Track payment statuses from draft to paid.',
      icon: <DocumentTextIcon className='h-6 w-6' />,
    },
    {
      name: 'Inventory Management',
      description:
        'Track stock levels, manage SKUs, and view item movement logs. Automatically deduct stock on paid invoices.',
      icon: <CollectionIcon className='h-6 w-6' />,
    },
    {
      name: 'Expense Tracking',
      description:
        'Record and categorize all business expenses to get a clear picture of your cash flow.',
      icon: <ReceiptRefundIcon className='h-6 w-6' />,
    },
    {
      name: 'Sales Analytics',
      description:
        'Visualize your business performance with insightful charts on revenue, profit, and top-selling items.',
      icon: <ChartPieIcon className='h-6 w-6' />,
    },
    {
      name: 'Staff Management',
      description:
        'Keep all employee records, roles, and contact information organized in one central place.',
    ...
    },
    {
      ...
      description:
        'Generate reports for sales and purchase taxes to make tax filing season a breeze.',
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='lg:text-center'>
            ...
            <p className='mt-4 max-w-2xl text-xl text-gray-500 dark:text-gray-300 lg:mx-auto'>
              Streamline Suite is packed with powerful features to help you save time, reduce
              errors, and grow your profits.
            </p>
          </div>
