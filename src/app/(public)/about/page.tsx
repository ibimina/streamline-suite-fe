    ...
    <div className='bg-white dark:bg-gray-800'>
        ...
        <div className='relative h-full flex items-center justify-center'>
          <div className='text-center'>
            ...
            <p className='mt-6 text-lg max-w-2xl mx-auto leading-8 text-gray-200'>
              We are a team of developers, designers, and industry veterans passionate about
      ...
      <div className='mx-auto max-w-7xl py-24 sm:py-32 px-6 lg:px-8'>
        <div className='mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2'>
          <div className='lg:pr-8 lg:pt-4'>
            <div className='lg:max-w-lg'>
              <h3 className='text-base font-semibold leading-7 text-teal-600 dark:text-teal-400'>
                Our Mission
              </h3>
              ...
              <p className='mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300'>
                Our mission is to empower small and medium-sized businesses with powerful, intuitive
                software. We aim to help you streamline your operations, eliminate administrative
                headaches, and achieve scalable growth by providing a tool that feels like it was
          ...
          <div className='lg:pr-8 lg:pt-4'>
            <div className='lg:max-w-lg'>
              ...
              <p className='mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300'>
                Streamline Suite was born after years of watching entrepreneurs and small business
                owners struggle with generic, clunky software that didn&apos;t fit their workflow.
                We decided to build something better: a single, elegant solution to manage the
                entire business lifecycle, from the initial quote to the final payment.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='mx-auto mt-24 max-w-2xl lg:mx-0 lg:max-w-none'>
          <h3 className='text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl text-center'>
            Meet Our Team
          </h3>
          <p className='mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300 text-center max-w-3xl mx-auto'>
            We’re a small, dedicated team that believes in the power of collaboration and
            craftsmanship.
          </p>
          <ul
            role='list'
            className='mt-16 grid gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-3 sm:gap-y-16 xl:col-span-2'
          >
              ...
              <li key={person?.name}>
                <div className='flex items-center gap-x-6'>
                  ...
                  <div>
                    ...
                    <p className='text-sm font-semibold leading-6 text-teal-600 dark:text-teal-400'>
                      {person?.role}
                    </p>
                  </div>
                </div>
