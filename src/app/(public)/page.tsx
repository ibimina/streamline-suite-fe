        ...
        <>
            ...
            <div className="relative isolate px-6 pt-14 lg:px-8">
                <div className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
                    <div className="relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#14b8a6] to-[#0d9488] opacity-30 sm:left-[calc(50%-30rem)] sm:w-288.75" style={{ clipPath: 'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)' }}></div>
                </div>
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    <div className="text-center">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                            Streamline Suite is the complete toolkit for quotes, invoices, inventory, and analytics. Stop juggling multiple apps and run your entire operation from one powerful, intuitive platform.
                        </p>
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            ...
                            <button onClick={() => onNavigate('features')} className="text-sm font-semibold leading-6 text-gray-900 dark:text-white">
            ...
            <div className="overflow-hidden bg-white dark:bg-gray-800 py-24 sm:py-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:text-center">
                        <h2 className="text-base font-semibold leading-7 text-teal-600 dark:text-teal-400">Everything in One Place</h2>
                        ...
                        <div className="lg:col-span-2 lg:pt-4">
                            <div className="lg:max-w-lg">
                                <p className="text-lg leading-8 text-gray-600 dark:text-gray-300">
                                    From the first quote to the final payment, Streamline Suite provides the tools you need to manage your business efficiently and professionally.
                                </p>
