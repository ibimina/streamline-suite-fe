        ...
        <div className='relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48 bg-gray-900'>
          ...
          <div className='relative mx-auto max-w-xl lg:mx-0 lg:max-w-lg'>
            ...
            <p className='mt-6 text-lg leading-8 text-gray-200'>
              Have questions about our features, pricing, or how Streamline Suite can help your
            ...
            <dl className='mt-10 space-y-4 text-base leading-7 text-gray-200'>
              ...
              <div className='flex gap-x-4'>
                ...
                <dd>
                  <a className='hover:text-white' href='mailto:hello@streamlinesuite.com'>
        ...
        <form onSubmit={handleSubmit} className='px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48'>
          <div className='mx-auto max-w-xl lg:mr-0 lg:max-w-lg'>
            ...
            <div className='mt-8 flex justify-end'>
              <button
                type='submit'
                className='rounded-md bg-teal-500 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-teal-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600'
              >
                Send message
              </button>
            </div>
